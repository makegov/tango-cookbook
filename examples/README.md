...
| [`looker-studio-connector/`](./looker-studio-connector/) | A market research dashboard in Looker Studio: one community connector, two datasets — requirements posting (SAM.gov) and awards won (FPDS) — demand next to supply in one report. Plus a Power Query recipe for Power BI. |
